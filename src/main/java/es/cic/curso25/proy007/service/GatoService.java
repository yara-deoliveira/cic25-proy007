...
public class GatoService {
    ...
    public Gato create(Gato gato) {
        LOGGER.info("Guardando el gato " + gato);
    ...
    public Gato get(Long id) {
        ...
        if (id == null) {
            LOGGER.info("Imposible; no se puede hallar un gato asociado a la id " + id);
            return null; 
        }
        else {
            LOGGER.info("Se obtiene el gato de id " + id);
    ...
    public List<Gato> get() {
        LOGGER.info("Se listan todos los gatos");
    ...
    public void update(Gato gato) {
        LOGGER.info("Se actualiza el gato " + gato);
        gatoRepository.save(gato);
    }
    ...
    public void delete(Long id) {
        LOGGER.info("Se elimina el gato de id " + id);
